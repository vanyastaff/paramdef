...
use crate::subtypes::{NumberSubtype, NumberUnit};
...
impl Number<crate::subtypes::GenericNumber> {
    ...
    pub fn builder(key: impl Into<Key>) -> NumberBuilder<crate::subtypes::GenericNumber> {
        NumberBuilder::new(key, crate::subtypes::GenericNumber)
    }

    /// Creates an integer number parameter builder.
    pub fn integer(key: impl Into<Key>) -> NumberBuilder<crate::subtypes::GenericNumber> {
        NumberBuilder::new(key, crate::subtypes::GenericNumber)
    }

    /// Creates a float number parameter builder.
    pub fn float(key: impl Into<Key>) -> NumberBuilder<crate::subtypes::GenericNumber> {
        NumberBuilder::new(key, crate::subtypes::GenericNumber)
    }
}
...
impl Number<crate::subtypes::Percentage> {
    ...
    pub fn percentage(key: impl Into<Key>) -> NumberBuilder<crate::subtypes::Percentage> {
        NumberBuilder::new(key, crate::subtypes::Percentage)
    }
}

impl Number<crate::subtypes::Port> {
    /// Creates a port number parameter builder.
    pub fn port(key: impl Into<Key>) -> NumberBuilder<crate::subtypes::Port> {
        NumberBuilder::new(key, crate::subtypes::Port)
    }
}

impl Number<crate::subtypes::Factor> {
    /// Creates a factor/multiplier parameter builder.
    pub fn factor(key: impl Into<Key>) -> NumberBuilder<crate::subtypes::Factor> {
        NumberBuilder::new(key, crate::subtypes::Factor)
    }
}
